                            ...
                            <li class="link">
                                ...
                                <li class="chapter inner">
                                    <div class="simple menu-toggler" data-toggle="collapse" ${ isNormalMode ?
                                        'data-target="#directives-links-module-ResizableModule-311257770967b12a6d30f8b2e560d117"' : 'data-target="#xs-directives-links-module-ResizableModule-311257770967b12a6d30f8b2e560d117"' }>
                                        <span class="icon ion-md-code-working"></span>
                                        <span>Directives</span>
                                        <span class="icon ion-ios-arrow-down"></span>
                                    </div>
                                    <ul class="links collapse" ${ isNormalMode ? 'id="directives-links-module-ResizableModule-311257770967b12a6d30f8b2e560d117"' :
                                        'id="xs-directives-links-module-ResizableModule-311257770967b12a6d30f8b2e560d117"' }>
                                        <li class="link">
                                            <a href="directives/ResizableDirective.html"
                                                data-type="entity-link" data-context="sub-entity" data-context-id="modules">ResizableDirective</a>
                                        </li>
                                        <li class="link">
                                            <a href="directives/ResizeHandleDirective.html"
                                                data-type="entity-link" data-context="sub-entity" data-context-id="modules">ResizeHandleDirective</a>
                                        </li>
                                    </ul>
                                </li>
                            </li>
